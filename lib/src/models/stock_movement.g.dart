...
extension StockMovementQuerySortBy
  ...
  QueryBuilder<StockMovement, StockMovement, QAfterSortBy> sortByDelta() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'delta', Sort.asc);
    });
  }

  QueryBuilder<StockMovement, StockMovement, QAfterSortBy> sortByDeltaDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StockMovementQuerySortThenBy
  ...
  QueryBuilder<StockMovement, StockMovement, QAfterSortBy> thenByDelta() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'delta', Sort.asc);
    });
  }

  QueryBuilder<StockMovement, StockMovement, QAfterSortBy> thenByDeltaDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'delta', Sort.desc);
    });
  }
...
extension StockMovementQueryWhereDistinct
  ...
  QueryBuilder<StockMovement, StockMovement, QDistinct> distinctByDelta() {
    return QueryBuilder.apply(this, (query) {
...
extension StockMovementQueryProperty
  ...
  QueryBuilder<StockMovement, int, QQueryOperations> deltaProperty() {
    return QueryBuilder.apply(this, (query) {
